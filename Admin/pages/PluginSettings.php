...
class PluginSettings extends AbstractPage
{
    private $plugin_settings_options;
    ...
    public function twitter_settings_add_plugin_page() {
        add_submenu_page(
            ...
            'Plugin Settings',
            'manage_options',
            'dt_atp_plugin_settings_admin_page',
            array( $this, 'plugin_settings_create_admin_page'
            )
        );
    }

    public function plugin_settings_create_admin_page() {
