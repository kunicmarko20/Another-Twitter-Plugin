...
class Another_Twitter_Plugin {
	...
	public function __construct() {
		...
		$this->plugin_name = 'another-twitter-plugin';
		$this->version = '1.1.0';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/another-twitter-plugin-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/another-twitter-plugin-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/another-twitter-plugin-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/another-twitter-plugin-public.php';

                /**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */                
                require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/pages/autoload.php';
		$this->loader = new Another_Twitter_Plugin_Loader();
	...
	private function set_locale() {
		...
		$plugin_i18n = new Another_Twitter_Plugin_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Another_Twitter_Plugin_Admin( $this->get_plugin_name(), $this->get_version() );
