...
1. Upload the plugin files to the `/wp-content/plugins/another-twitter-plugin` directory, or install the plugin through the WordPress plugins screen directly.
